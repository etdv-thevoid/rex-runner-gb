...
_AnimateMeteor2::
    ...
    ld hl, {METEOR_2_SPRITE_0} + OAMA_Y
    ld a, [hl]
    add a, b
    ld [hl+], a
    ld a, [hl]
    ...
    ld hl, {METEOR_2_SPRITE_1} + OAMA_Y
    ld a, [hl]
    add a, b
    ld [hl+], a
    ld a, [hl]
    ...
    ld hl, {METEOR_2_SPRITE_2} + OAMA_Y
    ld a, [hl]
    add a, b
    ld [hl+], a
    ld a, [hl]
